...
function MeasurementForm() {
  ...
  const isFormComplete = formData.berat !== '' && 
                         formData.tinggi !== '' && 
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor='lingkar_kepala' className="text-xs font-semibold text-slate-700">Lingkar Kepala (cm)</label>
                    <input 
                      type="number" 
                      step="0.1"
                      required
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor='lila' className="text-xs font-semibold text-slate-700">Lingkar Lengan (cm)</label>
                    <input 
                      type="number" 
                      step="0.1"
                      required
                ...
                <div className="flex flex-col gap-1.5 pt-4">
                  <label htmlFor='cara_ukur' className="text-xs font-semibold text-slate-700">Cara Ukur Tinggi</label>
                  <select 
              ...
              <div className="mt-10 md:mt-auto pt-4 md:pt-8">
                ...
                >
                  {isLoading ? (
                    ...
                    isFormComplete ? 'Simpan Data Pengukuran' : 'Lengkapi Data Dahulu'
                  )}
                </button>
              </div>
