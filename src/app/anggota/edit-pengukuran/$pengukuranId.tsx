...
function EditMeasurementForm() {
  ...
  useEffect(() => {
    const fetchExistingData = async () => {
      try {
        ...
        setFormData({
          tanggal_ukur: data.tanggal_ukur ? data.tanggal_ukur.split('T')[0] : '',
  ...
  const handleSimulateSensor = async () => {
    ...
    try {
      ...
      if (!weightRes.ok || !heightRes.ok) throw new Error('Gagal terhubung ke sensor alat ukur.');
            ...
            <div className="flex flex-col">
              ...
              <div className="relative bg-white rounded-2xl p-4 flex items-center gap-4 shadow-sm border border-slate-100 mb-8 overflow-hidden md:border-slate-200 md:shadow-md">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-slate-500 mt-0.5">Koreksi pengukuran</span>
                </div>
              </div>
              ...
              <div className="mt-10 md:mt-auto pt-4 md:pt-8 flex flex-col gap-3">
                ...
                >
                  {isLoading ? (
                    ...
                    isFormComplete ? 'Simpan Perubahan' : 'Lengkapi Data Dahulu'
                  )}
                </button>
